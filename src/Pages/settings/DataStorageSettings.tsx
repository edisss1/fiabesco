    ...
    return (
        <div className="flex flex-col gap-9 min-w-[350px]">
            <div className="flex items-center justify-between">
                ...
                <Button className="rounded-lg border-2 dark:border-text-primary-dark hover:border-transparent cursor-pointer hover:bg-secondary transition-colors duration-200 border-text-primary px-6 py-2">
                    Download
                </Button>
            </div>
