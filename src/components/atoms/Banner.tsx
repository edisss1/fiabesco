...
const Banner = ({ bannerURL }: BannerProps) => {
    return (
        <div className="w-full h-[150px] group relative after:inset-0 after:absolute after:bg-none hover:after:bg-black/50 after:transition-all after:duration-200 after:w-full after:content-[''] border-b-2 border-text-secondary after:rounded-b-xl rounded-b-xl after:z-40 ">
            {bannerURL ? (
                <img
